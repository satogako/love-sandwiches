...
'''
Зроблений рефакторинк цих двох закоментованих функцій. Тепер все 
оброблюється через одну фукцію update_worksheet!!! 
...
def main():
    ...
    #update_sales_worksheet(sales_data) - зроблений рефакторинг. 
